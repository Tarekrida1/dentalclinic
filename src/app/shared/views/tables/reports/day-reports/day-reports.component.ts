 ...
 rowData = [
   {
    name: 'خالد احمد',
    date: '03/31/2020',
    diagnostic: 'اسم التشخيص',
    service_name: 'كشف',
    procedures: 'نوع الاجراء ',
    paid: 200
  },
  {
    name: 'عمر خالد',
  ...
  constructor(private router : Router,private http: HttpClient,private toastr: ToastrService ,private modalService: NgbModal,private spinner: NgxSpinnerService) {
    ...
    this.cols = [
      ...
      { field: 'diagnostic', header: 'التشخيص' },
      { field: 'service_name', header: 'نوع الخدمة' },
      { field: 'procedures', header: 'الاجراء المتخذ' },
      { field: 'paid', header: 'الدفع' },
